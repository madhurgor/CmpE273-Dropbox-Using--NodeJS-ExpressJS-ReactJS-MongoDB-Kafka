...
function handle_request(msg, callback){
  ...
  logger.write('\r\n Fetching file name/s from folder '+msg.path+' on '+new Date(dt.now()));

  console.log(path.join(__dirname,'../../') + `${msg.username}/normal/${msg.path}/`);
  ...
  logger.write('\r\n End fetching file name/s from folder '+msg.path+' on '+new Date(dt.now()));
